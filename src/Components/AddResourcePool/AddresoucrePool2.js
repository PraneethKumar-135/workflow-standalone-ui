...
const items = (handleTabChange, borderVisible) => {
  ...
  const actuallengthofUi = length.UIDeveloperLength;
  const actuallengthofTester = length.TesterLength;
              ...
              <div className="flex justify-between items-center">
                <div className="flex">
                  ...
                  <div className="flex flex-col justify-start">
                    ...
                    <p className=" pl-2 w-32 text-left">{actuallengthofUx} Members</p>
                  </div>
                </div>
              ...
              <div className="flex justify-between items-center">
                <div className="flex">
                  ...
                  <div className="flex flex-col justify-start">
                    ...
                    <p className=" pl-2 w-32 text-left">{actuallengthofUi} Members</p>
                  </div>
                </div>
                <Button className="flex p-2 h-9 items-center gap-0 bg-blue-500">
                  <PlusOutlined className="text-white text-lg" />{" "}
              ...
              <div className="flex justify-between items-center">
                <div className="flex">
                  ...
                  <div className="flex flex-col justify-start">
                    ...
                    <p className=" pl-2 w-32 text-left">{actuallengthofApi} Members</p>
                  </div>
                </div>
                <Button className="flex p-2 h-9 items-center gap-0 bg-blue-500">
                  <PlusOutlined className="text-white text-lg" />{" "}
              ...
              <div className="flex justify-between items-center">
                <div className="flex">
                  ...
                  <div className="flex flex-col justify-start">
                    ...
                    <p className=" pl-2 w-32 text-left">{actuallengthofTester} Members</p>
                  </div>
                </div>
                <Button className="flex p-2 h-9 items-center gap-0 bg-blue-500">
                  <PlusOutlined className="text-white text-lg" />{" "}
              ...
              <div className="flex justify-between items-center">
                <div className="flex">
                  ...
                  <div className="flex flex-col justify-start">
                    ...
                    <p className=" pl-2 w-32 text-left">{actuallengthofUxr} Members</p>
                  </div>
                </div>
                <Button className="flex p-2 h-9 items-center gap-0 bg-blue-500">
                  <PlusOutlined className="text-white text-lg" />{" "}
              ...
              <div className="flex justify-between items-center">
                <div className="flex">
                  ...
                  <div className="flex flex-col justify-start">
                    ...
                    <p className=" pl-2 w-32 text-left">{actuallengthofUCicd} Members</p>
                  </div>
                </div>
                <Button className="flex p-2 h-9 items-center gap-0 bg-blue-500">
                  <PlusOutlined className="text-white text-lg" />{" "}
