      ...
      <div>
        ...
        {Object.keys(data).map((key, index) => {
          ...
          return (
            <div
              key={index}
              className={`mb-8 ${openItemIndex === index ? "border border-blue-500 p-5" : ""
                }`}
            >
              <div
                className={`mb-8 ${openItemIndex === index
              ...
              >
                <div className="flex gap-2">
                  ...
                  <span
                    className={`${data[key].status === "inprogress" ? "bg-[#ffbf3f88] px-2 py-1 rounded" : data[key].status === "pending" ? "bg-gray-400 px-2 py-1 rounded" : data[key].status === "unassigned" ? "bg-[#ffbf3f88] px-2 py-1 rounded" : "bg-lime-300 px-2 py-1 rounded" // Default color for complete status
                      }`}
                  >
                    {data[key].status}
                  </span>
